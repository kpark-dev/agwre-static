              ...
              <div class="w-full  m-auto lg:m-0 max-w-[720px] lg:pt-[120px]">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-5 lg:gap-[50px] items-center lg:items-start justify-center lg:justify-start">
                  <div class="w-full max-w-[484px] lg:max-w-[unset] flex flex-col items-center lg:items-start mx-auto lg:mx-0">
                    <p class="max-w-[unset] lg:max-w-[335px] text-xxs lg:text-s tracking-[2px] text-center lg:text-left mb-2 lg:mb-4">Locatıon </p>
                    <input type="text" class="max-w-[unset] lg:max-w-[335px] w-full h-14 bg-[#f8f8f9] rounded-[5px] !border-0 !ring-0 !outline-0">
                  </div>
                  <div class="w-full max-w-[484px] lg:max-w-[unset] flex flex-col items-center lg:items-start mx-auto lg:mx-0">
                    <p class="max-w-[unset] lg:max-w-[335px] text-xxs lg:text-s tracking-[2px] text-center lg:text-left mb-2 lg:mb-4">Property Price </p>
                    <input type="text" class="max-w-[unset] lg:max-w-[335px] w-full h-14 bg-[#f8f8f9] rounded-[5px] !border-0 !ring-0 !outline-0">
                  </div>
                  <div class="w-full max-w-[484px] lg:max-w-[unset] flex flex-col items-center lg:items-start mx-auto lg:mx-0">
                    <p class="max-w-[unset] lg:max-w-[335px] text-xxs lg:text-s tracking-[2px] text-center lg:text-left mb-2 lg:mb-4">Down Payment </p>
                    <input type="text" class="max-w-[unset] lg:max-w-[335px] w-full h-14 bg-[#f8f8f9] rounded-[5px] !border-0 !ring-0 !outline-0">
                  </div>
                  ...
                  <div class="w-full max-w-[484px] lg:max-w-[unset] flex flex-col items-center lg:items-start mx-auto lg:mx-0">
                    <p class="max-w-[unset] lg:max-w-[335px] text-xxs lg:text-s tracking-[2px] text-center lg:text-left mb-2 lg:mb-4">Interest rate</p>
                    <input type="text" class="max-w-[unset] lg:max-w-[335px] w-full h-14 bg-[#f8f8f9] rounded-[5px] !border-0 !ring-0 !outline-0">
                  </div>
