<!-- FOOTER -->
<footer class="w-full relative bg-white md:pb-10">
    <div class="row md:!px-10 !px-0">
        <div class="fullwidth-col">
            <div class="w-full max-w-[1461px] m-auto bg-primary px-5 md:px-10 xxl:px-[130px] pt-[46px] md:pt-14 xxl:pt-[108px] pb-[26px] md:pb-[45px] xxl:pb-20">
                ...
                <div>
                    <div class="flex gap-[62px] md:gap-10 justify-between items-start xxl:items-end">
                        <div class="hidden md:flex flex-col gap-10 items-center">
                        ...
                        <div class="w-full max-w-[140px] hidden md:flex gap-6 xxl:gap-9 text-right flex-col-reverse xxl:flex-col">
                            <div class="block xxl:hidden mt-[158px]">
                    ...
                    <div class="flex md:hidden items-end gap-[62px] justify-between -mt-5 mb-[65px]">
                        <div class="max-w-[93px]">
                            <a href="#" class="block text-right"><img loading="lazy" src="./images/mobile-footer-logo.svg" alt="logo" class="max-w-[93px] ml-auto" /></a>
                        </div>
                        <div class="max-w-[113px]">
                            <a href="#" class="block mb-10 text-right"><img loading="lazy" src="./images/rennie.svg" alt="logo" class="max-w-[75px] ml-auto" /></a>
                            <div class="w-full flex gap-6 text-right  flex-col">
                                <a href="#" class="text-lightWhite text-[11px]">Terms & conditions</a>
                                <a href="#" class="text-lightWhite text-[11px]">Cookie polıcy</a>
                                <a href="#" class="text-lightWhite text-[11px]">Prıvacy policy</a>
                            </div>
                        </div>
                    </div>
                    <div class="w-full hidden lg:block mt-20 text-right">
                        <p class="mb-0 text-lightWhite text-[10px] tracking-[4.2px]">2024 Atwater Group All Rights Reserved</p>
                    </div>
...
<!-- END OF FOOTER -->
<!-- submenu -->
<div class="drawer-side lg:hidden z-[11]">
    <div class="row !p-0 w-full bg-white min-h-[100vh] z-[11111111111]">
        <div class="fullwidth-col">
            <div class="w-full flex flex-col items-start justify-between min-h-[100vh]">
                <div class="block xxl:hidden py-5 md:py-[38px] px-5 md:px-10 w-full">
                    <div class="flex items-center justify-between w-full">
                        <a href="/">
                            <img src="images/mobile-logo.svg" alt="logo" class="max-w-[127px] md:max-w-[189px]" />
                        </a>
                        <label for="sidebar-menu" aria-label="close sidebar" class="drawer-overlay">
                            <img loading="lazy" src="images/icons/icon-menu.svg" alt="" />
                        </label>
                    </div>
                </div>
                <div class="mobileMenu px-6 pt-20 pb-16 w-full flex flex-col gap-4 items-start">
                    ...
                    <div class="border-b-1 border-solid border-darkGrey h-[1px] mt-6 w-full">&nbsp;</div>
