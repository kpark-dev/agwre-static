    ...
    <div class="row pt-[11px] md:pt-[68px] lg:pt-[184px] pb-[50px] md:pb-[90px] lg:pb-[150px]">
      <div class="fullwidth-col">
        <div class="max-w-[889px] m-auto">
          <h1 class="text-[43px] leading-[34px] md:text-[92px] md:leading-[74px] lg:text-[120px] lg:leading-[96px] mb-0 md:mb-[-205px] lg:mb-[-265px] z-[1] relative">Forward. <br />Our Favorite <br />Direction.</h1>
          <div class="flex items-center justify-between">
            <div class="max-w-[163px] md:max-w-[297px] lg:max-w-[350px] w-full">
            ...
            <div class="max-w-[119px] md:max-w-[315px] lg:max-w-[407px]">
          ...
          <div class="flex items-start justify-between">
            ...
            <div class="max-w-[119px]">
              <!-- mobile text -->
              <p class="pt-[70px] text-[11px] leading-[22px] block md:hidden opacity-75">At Atwatergroup, we believe that finding the perfect property and making real estate transactions should be a seamless and rewarding experience.</p>
            </div>
          </div>
        </div>
      </div>
