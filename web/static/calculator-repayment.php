        ...
        <div class="fullwidth-col">
          <div class="max-w-[1056px] m-auto">
            <div class="w-full flex flex-col items-center lg:items-start gap-[49px] md:gap-[65px] lg:gap-[70px] mb-[49px] lg:mb-[126px]">
              <h1 class="text-center lg:text-left text-[30px] leading-[24px] md:text-[50px] md:leading-[40px] lg:text-[90px] lg:leading-[72px] mb-0 relative font-cirka">Repayment Calculator</h1>
              <p class="text-center lg:text-left ml-auto lg:ml-0 mr-auto opacity-75 max-w-[493px] lg:max-w-[640px] mb-0 leading-[180%] text-[11px] md:text-s lg:text-md">Calculate your home loan repayments to work out what you can afford.</p>
            </div>
            <!-- form -->
            <div class="w-full grid grid-cols-1 lg:grid-cols-2 gap-[85px] md:gap-[73px] items-center lg:items-start justify-between">
              <div class="m-auto w-full max-w-[468px] lg:max-w-[496px]">
                <div class="w-full max-w-[468px] lg:max-w-[496px] m-auto">
                  <div class="w-full max-w-[496px] flex flex-col items-center lg:items-start pb-6 md:pb-[73px] lg:pb-[44px]">
                    <p class="max-w-[496px] text-xxs lg:text-s tracking-[2px] text-center lg:text-left mb-2 lg:mb-4 uppercase">What do you want to calculate?</p>
                    <div class="w-full grid grid-cols-2 gap-[14px] lg:gap-5">
                      <div class="optionItem2 col-span-1 active">Yes</div>
                      <div class="optionItem2 col-span-1">Interest only</div>
                    </div>
                  </div>
                  <div class="w-full max-w-[468px] lg:max-w-[496px] m-auto">
                    <div class="w-full max-w-[496px] flex flex-col items-center lg:items-start pb-6 md:pb-[73px] lg:pb-[44px]">
                  ...
                  <div class="w-full max-w-[496px] flex flex-col items-center lg:items-start pb-6 md:pb-[73px] lg:pb-[44px]">
                    <p class="max-w-[496px] text-xxs lg:text-s tracking-[2px] text-center lg:text-left mb-2 lg:mb-4 uppercase">Interest rate</p>
                    <input type="text" class="max-w-[496px] w-full h-14 bg-[#f8f8f9] rounded-[5px] !border-0 !ring-0 !outline-0">
                  </div>
                  <div class="w-full max-w-[496px] flex flex-col items-center lg:items-start pb-6 md:pb-[73px] lg:pb-[44px]">
                    <p class="max-w-[468px] lg:max-w-[335px] text-xxs lg:text-s tracking-[2px] text-center lg:text-left mb-2 lg:mb-4 uppercase">Loan term</p>
                    <input type="text" class="max-w-[468px] lg:max-w-[335px] w-full h-14 bg-[#f8f8f9] rounded-[5px] !border-0 !ring-0 !outline-0">
                  </div>
                  <div class="w-full max-w-[496px] flex flex-col items-center lg:items-start">
                    <a href="#" class="max-w-[496px] text-xxs lg:text-s tracking-[2px] text-center lg:text-left mb-2 lg:mb-4 uppercase">Contact us now</a>
                  </div>
                </div>
              </div>
              <div class="m-auto lg:ml-auto w-full max-w-[468px] lg:max-w-[432px] bg-primary rounded-[5px] py-5 lg:py-[25px] px-[27px] lg:px-[36px] h-full flex flex-col justify-between min-h-[446px] md:min-h-[285px]">
                <div class="flex justify-between items-start w-full">
                  <p class="text-white mb-0 text-[17px] md:text-[26px] tracking-[2px]">Estimated</p>
                  <div class="text-right md:text-left lg:text-center">
                    <p class="text-white mb-0 text-[25px] md:text-[34px] lg:text-[38px] font-semibold">$6,070</p>
                    <p class="text-white mb-0 text-[7px] md:text-[9px] lg:text-xxs tracking-[2px]">Per month</p>
                  </div>
                </div>
                <div class="w-full">
                  <div class="max-w-[148px] lg:max-w-[200px] ml-auto flex flex-col gap-5 lg:gap-[26px]">
                    <div class="flex gap-10 lg:gap-[50px] items-center">
                      <p class="min-w-[53px] text-right text-[8px] md:text-xxs lg:text-xs mb-0 text-white tracking-[2px]">Loan</p>
                      <p class="min-w-[53px] text-right text-xxs md:text-[13px] lg:text-lg mb-0 text-white font-semibold">$500,000</p>
                    </div>
                    <div class="flex gap-10 lg:gap-[50px] items-center">
                      <p class="min-w-[53px] text-right text-[8px] md:text-xxs lg:text-xs mb-0 text-white tracking-[2px]">Interest</p>
                      <p class="min-w-[53px] text-right text-xxs md:text-[13px] lg:text-lg mb-0 text-white font-semibold">$443,000</p>
                    </div>
                    <div class="flex gap-10 lg:gap-[50px] items-center">
                      <p class="min-w-[53px] text-right text-[8px] md:text-xxs lg:text-xs mb-0 text-white tracking-[2px]">Total</p>
                      <p class="min-w-[53px] text-right text-xxs md:text-[13px] lg:text-lg mb-0 text-white font-semibold">$993,000</p>
                    </div>
                  </div>
                </div>
              </div>
