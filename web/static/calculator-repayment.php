              ...
              <div class="m-auto w-full max-w-[468px] lg:max-w-[496px]">
                <div class="w-full max-w-[468px] lg:max-w-[496px] m-auto">
                  <div class="w-full max-w-[496px] flex flex-col items-center lg:items-start pb-6 md:pb-[73px] lg:pb-[44px]">
                    <p class="max-w-[496px] text-xxs lg:text-s tracking-[2px] text-center lg:text-left mb-2 lg:mb-4">What do you want to calculate?</p>
                  ...
                  <div class="w-full max-w-[496px] flex flex-col items-center lg:items-start pb-6 md:pb-[73px] lg:pb-[44px]">
                    <p class="max-w-[496px] text-xxs lg:text-s tracking-[2px] text-center lg:text-left mb-2 lg:mb-4">Interest rate</p>
                    <input type="text" class="max-w-[496px] w-full h-14 bg-[#f8f8f9] rounded-[5px] !border-0 !ring-0 !outline-0">
                  </div>
                  <div class="w-full max-w-[496px] flex flex-col items-center lg:items-start pb-6 md:pb-[73px] lg:pb-[44px]">
                    <p class="max-w-[468px] lg:max-w-[335px] text-xxs lg:text-s tracking-[2px] text-center lg:text-left mb-2 lg:mb-4">Loan term</p>
                  ...
                  <div class="w-full max-w-[496px] flex flex-col items-center lg:items-start">
                    <a href="#" class="max-w-[496px] text-xxs lg:text-s tracking-[2px] text-center lg:text-left mb-2 lg:mb-4">Contact us now</a>
                  </div>
                </div>
              </div>
