    ...
    <div class="row pt-[11px] md:pt-[68px] lg:pt-[184px] pb-[50px] md:pb-[90px] lg:pb-[150px]">
      <div class="fullwidth-col">
        <div class="max-w-[1076px] m-auto">
          <div class="w-full flex flex-col lg:flex-row items-center gaop-[38px] md:gap-[48px] lg:gap-[86px] mb-[53px] md:mb-[40px] lg:mb-[76px]">
            <h1 class="text-[45px] leading-[36px] md:text-[50px] md:leading-[63px] lg:text-[120px] lg:leading-[96px] mb-10 relative font-cirka">Contact us</h1>
            <p class="max-w-[401px] mb-0 leading-[180%] text-[11px] md:text-xxs lg:text-md">We’re here to support you at every stage of your home buying journey. So, use our LiveChat, flick us an email or pick up the phone and let us help.</p>
          </div>
          <form class="w-full">
            <div class="flex flex-col md:flex-row gap-[134px] md:gap-[94px] lg:gap-[154px] items-start justify-start">
              <div class="w-full max-w-[493px] m-auto md:m-0">
                <p class="text-xxs md:text-[11px] lg:text-xs mb-[11px] md:mb-[14px] lg:mb-[17px] font-bold tracking-[2px]">Your name</p>
                <input type="text" class="w-full bg-[#f8f8f9] rounded-[5px] px-4 py-[11px] lg:py-[15px] mb-8 !border-0 !outline-0 !ring-0" />
                <p class="text-xxs md:text-[11px] lg:text-xs mb-[11px] md:mb-[14px] lg:mb-[17px] font-bold tracking-[2px]">Your phone number</p>
                <input type="text" class="w-full bg-[#f8f8f9] rounded-[5px] px-4 py-[11px] lg:py-[15px] mb-8 !border-0 !outline-0 !ring-0" />
                <p class="text-xxs md:text-[11px] lg:text-xs mb-[11px] md:mb-[14px] lg:mb-[17px] font-bold tracking-[2px]">Your email address</p>
                <input type="email" class="w-full bg-[#f8f8f9] rounded-[5px] px-4 py-[11px] lg:py-[15px] mb-8 !border-0 !outline-0 !ring-0" />

                <div class="w-full max-w-[926px] flex md:hidden flex-col md:flex-row lg:flex-col gap-[37px] md:gap-[83px] lg:gap-[65px] items-center md:items-end">
                  <div class="w-full">
                    <p class="text-xxs md:text-[11px] lg:text-xs mb-[11px] md:mb-[14px] lg:mb-[17px] font-bold tracking-[2px]">Your message</p>
                    <textarea class="w-full min-h-[130px] max-w-[926px] bg-[#f8f8f9] rounded-[5px] px-4 py-[11px] lg:py-[15px] !border-0 !outline-0 !ring-0"></textarea>
                  </div>
                  <div class="w-full max-w-[244px]">
                    <button href="#" class="ml-auto w-[244px] h-[58px] text-lightWhite bg-primary rounded-[5px] text-[11px] text-center block leading-[58px] tracking-[1px] hover:opacity-80">Submıt</button>
                  </div>
                </div>
              </div>
              <div class="w-full md:w-duto text-center md:text-left flex flex-col gap-[67px] items-center md:items-start">
                <div class="w-full">
                  <p class="text-s md:text-xs lg:text-s mb-[27px] md:mb-[22px] lg:mb-[27px] font-bold tracking-[2px]">Call us</p>
                  <p class="mb-0 text-[11px] tracking-[2px]">778-877-7887</p>
                </div>
                <div class="w-full">
                  <p class="text-s md:text-xs lg:text-s mb-[27px] md:mb-[22px] lg:mb-[27px] font-bold tracking-[2px]">Email Us</p>
                  <p class="mb-0 text-[11px] tracking-[2px]">Info@atwatergroup.ca</p>
                </div>
                <div class="w-full">
                  <p class="text-s md:text-xs lg:text-s mb-[27px] md:mb-[22px] lg:mb-[27px] font-bold tracking-[2px]">Follow us</p>
                  <div class="m-auto md:m-0 w-full flex items-center justify-center md:justify-start gap-[36px]">
                    <a href="#">
                      <i class="bg-icon-facebook bg-no-repeat bg-center block w-[9px] h-[17px]">&nbsp;</i>
                    </a>
                    <a href="#">
                      <i class="bg-icon-instagram bg-no-repeat bg-center block w-[15px] h-[15px]">&nbsp;</i>
                    </a>
                    <a href="#">
                      <i class="bg-icon-twitter bg-no-repeat bg-center block w-[15px] h-[13px]">&nbsp;</i>
                    </a>
                    <a href="#">
                      <i class="bg-icon-pinterest bg-no-repeat bg-center block w-[13px] h-[17px]">&nbsp;</i>
                    </a>
                  </div>
                </div>
              </div>
            </div>
            <div class="hidden w-full max-w-[926px] md:flex flex-col md:flex-row lg:flex-col gap-[37px] md:gap-[83px] lg:gap-[65px] items-center md:items-end">
              <div class="w-full">
                <p class="text-xxs md:text-[11px] lg:text-xs mb-[11px] md:mb-[14px] lg:mb-[17px] font-bold tracking-[2px]">Your message</p>
                <textarea class="w-full min-h-[130px] max-w-[926px] bg-[#f8f8f9] rounded-[5px] px-4 py-[11px] lg:py-[15px] !border-0 !outline-0 !ring-0"></textarea>
              </div>
