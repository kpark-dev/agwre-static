        ...
        <div class="fullwidth-col">
          <div class="max-w-[1076px] m-auto">
            <div class="w-full flex flex-col items-center lg:items-start gap-[49px] md:gap-[65px] lg:gap-[70px] mb-[49px] lg:mb-[126px]">
              <h1 class="text-center lg:text-left text-[30px] leading-[24px] md:text-[50px] md:leading-[40px] lg:text-[90px] lg:leading-[72px] mb-0 relative font-cirka">Frequently Asked <br />Questions</h1>
              <p class="text-center lg:text-left ml-auto lg:ml-0 mr-auto opacity-75 max-w-[493px] lg:max-w-[640px] mb-0 leading-[180%] text-[11px] md:text-s lg:text-md">Here are some of the questions we’re asked most often. If you need additional help, please don’t hesitate to reach out. We’re available anytime </p>
            </div>
            <!-- tabs -->
            <div class="w-full hidden lg:block">
              <div role="tablist" class="tabs tabs-bordered">
                <input type="radio" name="my_tabs_1" role="tab" class="tab" aria-label="Getting started" />
                <div role="tabpanel" class="tab-content pt-[73px]">
                  <!-- faq -->
                  <div class="w-full max-w-[493px] lg:max-w-[1021px] ml-auto mr-auto lg:mr-0  flex flex-col items-center gap-[15px] lg:gap-8">
                ...
                <input type="radio" name="my_tabs_1" role="tab" class="tab" aria-label="Working with us" checked="checked" />
                <div role="tabpanel" class="tab-content pt-[73px]">
                  <!-- faq -->
                  <div class="w-full max-w-[493px] lg:max-w-[1021px] ml-auto mr-auto lg:mr-0  flex flex-col items-center gap-[15px] lg:gap-8">
                    <div class="accordion-holder">
                ...
                <input type="radio" name="my_tabs_1" role="tab" class="tab" aria-label="Working with usCashbacks" />
                <div role="tabpanel" class="tab-content pt-[73px]">
                  <!-- faq -->
                  <div class="w-full max-w-[493px] lg:max-w-[1021px] ml-auto mr-auto lg:mr-0  flex flex-col items-center gap-[15px] lg:gap-8">
                    <div class="accordion-holder">
                ...
                <input type="radio" name="my_tabs_1" role="tab" class="tab" aria-label="Ready to move" />
                <div role="tabpanel" class="tab-content pt-[73px]">
                  <!-- faq -->
                  <div class="w-full max-w-[493px] lg:max-w-[1021px] ml-auto mr-auto lg:mr-0  flex flex-col items-center gap-[15px] lg:gap-8">
                    <div class="accordion-holder">
                ...
                <input type="radio" name="my_tabs_1" role="tab" class="tab" aria-label="Atwater service" />
                <div role="tabpanel" class="tab-content pt-[73px]">
                  <!-- faq -->
                  <div class="w-full max-w-[493px] lg:max-w-[1021px] ml-auto mr-auto lg:mr-0  flex flex-col items-center gap-[15px] lg:gap-8">
                    <div class="accordion-holder">
                ...
                <input type="radio" name="my_tabs_1" role="tab" class="tab" aria-label="About Atwater" />
                <div role="tabpanel" class="tab-content pt-[73px]">
                  <!-- faq -->
                  <div class="w-full max-w-[493px] lg:max-w-[1021px] ml-auto mr-auto lg:mr-0  flex flex-col items-center gap-[15px] lg:gap-8">
                    <div class="accordion-holder">
              ...
              <div class="w-full text-center">
                <details class="dropdown mb-[38px]">
                  ...
                  <ul class="menu dropdown-content bg-base-100 rounded-box z-[1] w-52 p-2 shadow">
                    ...
                    <li><a>Working with us</a></li>
                    <li><a>Cashbacks</a></li>
                    <li><a>Ready to move</a></li>
                    <li><a>Atwater service</a></li>
                    <li><a>About Atwater</a></li>
                  </ul>
                </details>
              </div>
              <!-- faq -->
