    ...
    <div class="w-full">
      <div class="row pt-[11px] md:pt-[68px] lg:pt-[184px] pb-[50px] md:pb-[90px] lg:pb-[150px]">
        <div class="fullwidth-col">
          <div class="max-w-[1278px] m-auto">
            <div class="w-full flex flex-col items-center lg:items-start gap-[39px] md:gap-[60px] lg:gap-[57px] mb-[49px] lg:mb-[126px]">
              <h1 class="text-center lg:text-left text-[30px] leading-[24px] md:text-[50px] md:leading-[40px] lg:text-[90px] lg:leading-[72px] mb-0 relative font-cirka">Property Transfer Tax (PTT)</h1>
              <p class="text-center lg:text-left ml-auto lg:ml-0 mr-auto opacity-75 max-w-[493px] lg:max-w-[695px] mb-0 leading-[180%] text-[11px] md:text-s lg:text-md">The Property Transfer Tax is a tax payable to the Provincial Government by purchasers of real estate. The tax applies to all types of real estate, whether residential, commercial or industrial. </p>
            </div>
            <div class="w-full flex flex-col lg:flex-row gap-[110px] lg:gap-[87px] items-start">
              <div class="w-full mx-auto max-w-[532px]">
                <h2 class="text-lead md:text-[30px] lg:text-[60px] mb-[45px] md:mb-[59px] lg:mb-[89px] font-circka">Standard Calculator</h2>
                <p class="text-[11px] md:text-[12px] lg:text-md max-w-[445px] lg:max-w-[433px] text-center lg:text-left mb-[45px] lg:mb-[90px] opacity-75 leading-[180%]">The first calculator is what we call our standard calculator. This is to be used if the Buyer is not a First Time Home Buyer, or if they are purchasing a used home, not a new one.</p>
                <div class="w-full max-w-[468px] lg:max-w-[358px] flex flex-col items-center lg:items-start mb-5 lg:mb-[47px]">
                  <p class="max-w-[468px] lg:max-w-[358px] text-xxs lg:text-s tracking-[2px] text-center lg:text-left mb-2 lg:mb-4">Gift or Loan </p>
                  <input type="text" class="max-w-[468px] lg:max-w-[358px] w-full h-14 bg-[#f8f8f9] rounded-[5px] !border-0 !ring-0 !outline-0">
                </div>
                <div class="w-full max-w-[468px] lg:max-w-[358px] flex flex-col items-center lg:items-start">
                  <p class="max-w-[468px] lg:max-w-[358px] text-xxs lg:text-s tracking-[2px] text-center lg:text-left mb-2 lg:mb-4">Interest rate </p>
                  <input type="text" class="max-w-[468px] lg:max-w-[358px] w-full h-14 bg-[#f8f8f9] rounded-[5px] !border-0 !ring-0 !outline-0">
                </div>
              </div>
              <div class="w-full mx-auto max-w-[679px]">
                ...
                <div class="flex flex-col gap-11 lg:gap-8 items-center lg:items-start pt-[88px] md:pt-[72px] lg:pt-[82px]">
                  <div class="flex gap-[38px] lg:gap-[50px] items-center mb-0">
                    <div class="w-[15px] h-[15px] bg-[#0e202c]">&nbsp;</div>
                    <p class="tracking-[2px] text-xxs md:text-xs mb-0">Tax on amount under $200,000 </p>
                  </div>
                  <div class="flex gap-[38px] lg:gap-[50px] items-center mb-0">
                    <div class="w-[15px] h-[15px] bg-[#B9C5D1]">&nbsp;</div>
                    <p class="tracking-[2px] text-xxs md:text-xs mb-0">Tax on amount over $200,000 & up to $2,000,000 </p>
                  </div>
                  <div class="flex gap-[38px] lg:gap-[50px] items-center mb-0">
                    <div class="w-[15px] h-[15px] bg-[#0e202c66]">&nbsp;</div>
                    <p class="tracking-[2px] text-xxs md:text-xs mb-0">Tax on amount over $2,000,000 & up to $3,000,000 </p>
                  </div>
                  <div class="flex gap-[38px] lg:gap-[50px] items-center mb-0">
                    <div class="w-[15px] h-[15px] bg-[#DFE6EE]">&nbsp;</div>
                    <p class="tracking-[2px] text-xxs md:text-xs mb-0">Tax on amount over $3,000,000 </p>
                  </div>
                </div>
                <div class="w-full flex justify-between items-start max-w-[500px] pt-[60px] md:pt-[85px] lg:pt-[91px]">
                  <p class="text-[28px] lg:text-[30px] mb-0 tracking-[4px]  font-semibold">Total tax</p>
                  <div>
                    <p class="text-[24px] lg:text-[32px] mb-0 font-semibold">$168000</p>
                    <p class="text-[9px] lg:text-[12px] mb-0">Total</p>
                  </div>
                </div>
              </div>
            </div>
...
<div class="hidden md:block row py-[67px] md:py-[137px]">
  <div class="fullwidth-col">
    <div class="w-full max-w-[965px] m-auto">
      <h2 class="text-center text-[40px] lg:text-[60px] mb-[55px] lg:mb-[85px] font-cirka">Exemption Calculator </h2>
      <div class="flex justify-between items-start gap-[45px] lg:gap-[158px] flex-col md:flex-row">
        <div class="mx-auto max-w-[427px] w-full">
          <p class="text-center md:text-right leading-[180%] text-[11px] lg:text-md opacity-75">This is used to calculate exemption amount if the Buyer is a First Time Home Buyer or if they are purchasing a newly built home.</p>
        </div>
        <div class="m-auto max-w-[394px] w-full">
          <div class="max-w-[297px] mx-auto lg:mx-0">
            <p class="text-center md:text-left text-[9px] lg:text-xs tracking-[2px] mb-[13px] lg:mb-[17px]">I am a</p>
            <div class="flex flex-col w-full gap-[14px] lg:gap-[18px]">
              <div class="optionItem2 active w-full">First Time Home Buyer</div>
              <div class="optionItem2 w-full">Newly Built Home Buyer</div>
            </div>
          </div>
        </div>
      </div>
      <div class="pt-[45px] lg:pt-0 flex justify-between items-center gap-[45px] lg:gap-[158px] flex-col-reverse md:flex-row">
        <div class="mx-auto max-w-[427px] w-full">
          <div class="w-full flex justify-between items-center">
            <p class="text-s lg:text-lg mb-10 lg:mb-[102px] tracking-[2px]  font-semibold">Exemption Amount</p>
            <p class="text-lead mb-10 lg:mb-[102px] font-semibold">$2000.00</p>
          </div>
          <div class="text-center md:text-right w-full">
            <p class="text-[23px] lg:text-[30px] mb-0 tracking-[6px] font-semibold">Tax Payable</p>
            <p class="text-[24px] lg:text-[32px] mb-0 font-semibold">$168000</p>
            <p class="text-[9px] lg:text-[12px] mb-0">Total</p>
          </div>
        </div>
        <div class="m-auto max-w-[394px] w-full">
          <div class="w-full max-w-[484px] lg:max-w-[496px] flex flex-col items-center lg:items-start">
            <p class="max-w-[394px] text-xxs lg:text-s tracking-[2px] text-center lg:text-left mb-2 lg:mb-4">Market value</p>
            <input type="text" class="max-w-[394px] w-full h-14 bg-[#f8f8f9] rounded-[5px] !border-0 !ring-0 !outline-0">
          </div>
        </div>
      </div>
    </div>
